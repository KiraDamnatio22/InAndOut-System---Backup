...
class MainWindow(ctk.CTk):
    ...
    def __init__(self):
        ...
        # self.repo.record_product_stock_in("E2602072322002", 10)  # Polytape
    ...
    def build_payment_panel(self):
        ...
        cash_options_frame.grid(row=2, column=0, padx=5, pady=(5, 20), sticky="ew")
        ...
        self.cash_status_label.grid(row=3, column=0, pady=(0, 20))
        ...
        if self.checkout_total % step == 0:
            ...
            self.exact_button.grid(row=4, column=0, pady=(0, 10))
        else:
    ...
    def build_payment_charge_section(self):
        ...
        total_charge_frame.grid_columnconfigure((0, 1), weight=1)

        left_frame = ctk.CTkFrame(total_charge_frame)
        left_frame.grid(row=0, column=0, padx=(105, 20))
    ...
    def freeze_layout(self, widget):
        ...
        # use around big updates
        # self.freeze_layout(self.items_frame)
        # self.unfreeze_layout(self.items_frame)
    ...
    def add_to_ticket(self, item, qty=1):
        if qty <= 0:
            return
        ...
        # remaining stock
        remaining = item["stock"] - current_qty
        ...
        self.ticket_model.add_item(item, qty)
    ...
    def open_receipt_printing_window(self):
        ...
        def generate_receipt(purchases, **details):
            ...
            receipt += f" DATE: 1/14/2026 {'TIME:':>15} {"10:14:56 AM"}\n"
            receipt += "-" * RECEIPT_WIDTH + "\n"
